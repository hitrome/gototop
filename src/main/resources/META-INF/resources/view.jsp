...
goToTopImageStyle.append("-moz-background-size: contain;");
goToTopImageStyle.append("-webkit-background-size: contain;");
goToTopImageStyle.append("-o-background-size: contain;");
goToTopImageStyle.append("background-size: contain;");
goToTopImageStyle.append("background-position: center;");
